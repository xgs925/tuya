package com.xgs925.tuya.common.view.bottompopview;
...
public class BottomPopView {
    ...
    private BottomPopViewAdapter mBottomPopViewAdapter;
    private PopupWindow popupWindow;
    private View mParent;
    private boolean show;
    private int mHight = 200;//px

    public void setAdapter(BottomPopViewAdapter bottomPopViewAdapter) {
    ...
    public BottomPopView(Context context, @NonNull View parent) {
    ...
    public void showWithSoftInput() {
        if (show) return;
        if (mBottomPopViewAdapter == null) return;
        InputMethodManager imm = (InputMethodManager) mContext.getSystemService(android.content.Context.INPUT_METHOD_SERVICE);
